...
static real_T c1_abs(SFc1_campus_windowsInstanceStruct *chartInstance, real_T
                     c1_x);
static real_T c1_sign(SFc1_campus_windowsInstanceStruct *chartInstance, real_T
                      c1_x);
...
static uint8_T c1_f_emlrt_marshallIn(SFc1_campus_windowsInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sign(SFc1_campus_windowsInstanceStruct *chartInstance, real_T
                      *c1_x);
  ...
  *chartInstance)
{
  ...
  c1_h_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  c1_refPower = 4.0999999999999995E+6;
  ...
  guard3 = FALSE;
  if (CV_EML_COND(0, 1, 0, c1_time >= c1_startTime)) {
    if (CV_EML_COND(0, 1, 1, c1_time <= c1_endTime)) {
  ...
  c1_ChWTempControl2 = c1_ChWTempControl1;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 114);
  CV_EML_IF(0, 1, 20, c1_satVar == 1.0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 118);
  guard2 = FALSE;
  if (CV_EML_COND(0, 1, 2, c1_time >= c1_startTime)) {
    if (CV_EML_COND(0, 1, 3, c1_time <= c1_endTime)) {
      CV_EML_MCDC(0, 1, 1, TRUE);
      CV_EML_IF(0, 1, 21, TRUE);
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 120);
      c1_c_b = c1_totPower - c1_refPower;
      c1_d_y = 7.0E-7 * c1_c_b;
      c1_d_b = c1_speedPower;
      c1_e_y = 0.0 * c1_d_b;
      c1_deltaControl = c1_d_y + c1_e_y;
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 121);
      if (CV_EML_IF(0, 1, 22, c1_abs(chartInstance, c1_deltaControl) > 0.5)) {
        _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 122);
        c1_b_a = c1_deltaControl;
        c1_b_sign(chartInstance, &c1_b_a);
        c1_deltaControl = c1_b_a * 0.5;
      }
  ...
  if (CV_EML_COND(0, 1, 4, c1_time >= c1_startTime)) {
    if (CV_EML_COND(0, 1, 5, c1_time <= c1_endTime)) {
      ...
      c1_e_b = c1_totPower - c1_refPower;
      c1_f_y = 7.0E-7 * c1_e_b;
      c1_f_b = c1_speedPower;
      c1_g_y = 0.0 * c1_f_b;
      c1_deltaControl = c1_f_y + c1_g_y;
      ...
      if (CV_EML_IF(0, 1, 27, c1_abs(chartInstance, c1_deltaControl) > 0.5)) {
        ...
        c1_c_a = c1_deltaControl;
        c1_b_sign(chartInstance, &c1_c_a);
        c1_deltaControl = c1_c_a * 0.5;
      }
                      ...
                      c1_x)
{
  real_T c1_b_x;
  c1_b_x = c1_x;
  c1_b_sign(chartInstance, &c1_b_x);
  return c1_b_x;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1699032543U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1119672855U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2692482912U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1620413093U);
}
...
mxArray *sf_c1_campus_windows_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("JGlplBFxcfasKgsiqwyVdG");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,3482);
        ...
        _SFD_CV_INIT_EML_IF(0,1,15,1372,1390,-1,2028);
        _SFD_CV_INIT_EML_IF(0,1,16,1411,1450,-1,1980);
        _SFD_CV_INIT_EML_IF(0,1,17,1551,1577,-1,1640);
        _SFD_CV_INIT_EML_IF(0,1,18,1738,1772,1817,1972);
        _SFD_CV_INIT_EML_IF(0,1,19,1817,1855,1900,1972);
        _SFD_CV_INIT_EML_IF(0,1,20,2036,2050,-1,2652);
        _SFD_CV_INIT_EML_IF(0,1,21,2092,2131,-1,2620);
        _SFD_CV_INIT_EML_IF(0,1,22,2232,2258,-1,2321);
        _SFD_CV_INIT_EML_IF(0,1,23,2414,2444,2481,2612);
        _SFD_CV_INIT_EML_IF(0,1,24,2481,2515,2552,2612);
        _SFD_CV_INIT_EML_IF(0,1,25,2661,2676,-1,3338);
        _SFD_CV_INIT_EML_IF(0,1,26,2748,2787,-1,3296);
        _SFD_CV_INIT_EML_IF(0,1,27,2888,2914,-1,2977);
        _SFD_CV_INIT_EML_IF(0,1,28,3071,3102,3144,3288);
        _SFD_CV_INIT_EML_IF(0,1,29,3144,3180,3222,3288);

        {
          static int condStart[] = { 1414, 1435 };

          static int condEnd[] = { 1431, 1450 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,1414,1450,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2095, 2116 };

          static int condEnd[] = { 2112, 2131 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,2095,2131,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2751, 2772 };

          static int condEnd[] = { 2768, 2787 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,2751,2787,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c1_campus_windows(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3491359762U));
  ssSetChecksum1(S,(2009121993U));
  ssSetChecksum2(S,(467271581U));
  ssSetChecksum3(S,(3133015113U));
