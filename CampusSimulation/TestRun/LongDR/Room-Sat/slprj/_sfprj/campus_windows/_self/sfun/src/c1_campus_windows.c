...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3752309765U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3889966993U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1680013252U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(768940579U);
}
...
mxArray *sf_c1_campus_windows_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("uXEU9OqmW6UQ6ktTn3V23G");
...
static void mdlSetWorkWidths_c1_campus_windows(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2442771637U));
  ssSetChecksum1(S,(3319173498U));
  ssSetChecksum2(S,(2024871161U));
  ssSetChecksum3(S,(1874884630U));
