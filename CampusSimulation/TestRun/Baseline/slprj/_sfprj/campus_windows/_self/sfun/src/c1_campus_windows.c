...
static const char * c1_debug_family_names[37] = { "coolSP", "heatSP",
  ...
  "maxSatV", "minRoomV", "maxRoomV", "startTime", "endTime", "Kp", "Kv",
  ...
  *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_endTime, 22U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_Kp, 23U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Kv, 24U, c1_b_sf_marshallOut);
  ...
  if (CV_EML_COND(0, 1, 0, c1_time >= c1_startTime)) {
    if (CV_EML_COND(0, 1, 1, c1_time <= c1_endTime)) {
      ...
      c1_b_y = 5.6830168459916314E-5 * c1_b;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2180795641U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2334768841U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(360041302U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1314039501U);
}
...
mxArray *sf_c1_campus_windows_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yJngVWPCEjhVYz4irDv1pG");
...
static void mdlSetWorkWidths_c1_campus_windows(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(675335394U));
  ssSetChecksum1(S,(4238505912U));
  ssSetChecksum2(S,(2617088914U));
  ssSetChecksum3(S,(1613505927U));
